  ...
  return (
    <Box padding={{ px: 16, py: 16 }}>
      <div className="flex flex-col lg:flex-row lg:justify-between">
        ...
        <div className="w-full flex items-end justify-end gap-[8px] mt-[10px] lg:w-auto lg:mt-[0] lg:justify-end">
          <Btn size="sm" minWidth={"95px"} iconMode="reset" onClick={reset}>초기화</Btn>
          <Btn type="submit" minWidth={"75px"} size="sm" onClick={submit}>검색</Btn>
        </div>
      </div>
    </Box>
  );
